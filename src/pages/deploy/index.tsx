...
import { DeployColumn, DeployTopButton, DeployFooter, ConectedPipe } from '@/components/deploy.component';
        ...
        <Container className="bg-dark-primary ">
          ...
          >
            ...
            <Row className="d-flex flex-column flex-md-row justify-content-evenly mt-lg-1 px-3">
              <Col xl={5} className="bg-soft-dark-primary-3 py-4 p-md-4 my-4 my-md-0 rounded d-flex flex-column ">
                {/* btn  */}
